...
<head>
    <meta charset="UTF-8">
    <title>Salles triées par capacité décroissante – <?php echo strtoupper($mode); ?></title>
    <style>
        table {
...
<body>
    <h1>Salles triées par capacité décroissante (mode : <?php echo strtoupper($mode); ?>)</h1>
