...
dans un tableau html. La première ligne de votre tableau html doit contenir le nom des champs. Les suivantes doivent contenir les données présentes dans votre base de
données.
 */
...
<head>
    <meta charset="UTF-8">
    <title>Capacité moyenne des salles – <?php echo strtoupper($mode); ?></title>
    <style>
        table {
...
<body>
    <h1>Capacité moyenne des salles (mode : <?php echo strtoupper($mode); ?>)</h1>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td><?php echo htmlspecialchars($resultat['capacite_moyenne']); ?></td>
            </tr>
        </tbody>
    </table>
</body>
